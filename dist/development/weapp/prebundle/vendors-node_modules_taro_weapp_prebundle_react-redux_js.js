...
var require_use_sync_external_store_with_selector_development = (0,_chunk_QRPWKJ4C_js__WEBPACK_IMPORTED_MODULE_1__.__commonJS)({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js" (exports) {
        ...
        (function() {
            ...
            var React2 = (0,_chunk_XDFXK7K5_js__WEBPACK_IMPORTED_MODULE_0__.require_react)(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore2 = React2.useSyncExternalStore, useRef2 = React2.useRef, useEffect2 = React2.useEffect, useMemo2 = React2.useMemo, useDebugValue2 = React2.useDebugValue;
...
var require_with_selector = (0,_chunk_QRPWKJ4C_js__WEBPACK_IMPORTED_MODULE_1__.__commonJS)({
...
var React = (0,_chunk_QRPWKJ4C_js__WEBPACK_IMPORTED_MODULE_1__.__toESM)((0,_chunk_XDFXK7K5_js__WEBPACK_IMPORTED_MODULE_0__.require_react)(), 1);
var import_with_selector = (0,_chunk_QRPWKJ4C_js__WEBPACK_IMPORTED_MODULE_1__.__toESM)(require_with_selector(), 1);
var IS_REACT_19 = React.version.startsWith("19");
var REACT_ELEMENT_TYPE = Symbol.for(IS_REACT_19 ? "react.transitional.element" : "react.element");
...
function finalPropsSelectorFactory(dispatch, _param) {
    var { initMapStateToProps, initMapDispatchToProps, initMergeProps } = _param, options = _object_without_properties(_param, [
        "initMapStateToProps",
...
function defaultMergeProps(stateProps, dispatchProps, ownProps) {
    return _object_spread({}, ownProps, stateProps, dispatchProps);
}
...
forwardRef: forwardRef2 = false, // the context consumer to use
context = ReactReduxContext } = {}) {
    ...
    const wrapWithConnect = (WrappedComponent)=>{
        ...
        function ConnectFunction(props) {
            const _React_useMemo = React.useMemo(()=>{
                const { reactReduxForwardedRef: reactReduxForwardedRef2 } = props, wrapperProps2 = _object_without_properties(props, [
                ...
                props
            ]), [propsContext, reactReduxForwardedRef, wrapperProps] = _React_useMemo;
            const ContextToUse = React.useMemo(()=>{
                let ResultContext = Context;
                if (propsContext === null || propsContext === void 0 ? void 0 : propsContext.Consumer) {
                    if (true) {
                        const isValid = isContextConsumer(// @ts-ignore
            ...
            const overriddenContextValue = React.useMemo(()=>{
                ...
                return _object_spread_props(_object_spread({}, contextValue), {
                    subscription
                });
            }, [
                didStoreComeFromProps,
...
`;
            ...
            const renderedWrappedComponent = React.useMemo(()=>{
                return(// @ts-ignore
                React.createElement(WrappedComponent, _object_spread_props(_object_spread({}, actualChildProps), {
        ...
        if (forwardRef2) {
            const _forwarded = React.forwardRef(function forwardConnectRef(props, ref) {
                return React.createElement(Connect, _object_spread_props(_object_spread({}, props), {
        ...
        const wrappedSelector = React.useCallback({
            [selector.name] (state) {
                ...
                if (true) {
                    ...
                    const { identityFunctionCheck: finalIdentityFunctionCheck, stabilityCheck: finalStabilityCheck } = _object_spread({
                        stabilityCheck,
                        identityFunctionCheck
                    }, devModeChecks);
